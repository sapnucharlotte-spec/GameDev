    ...
    "Hagwarth": {
        ...
        "Enemies": {
            ...
            2: {"name": "Hagorn", "hp": 75, "atk": randint(30,50), "def": 25, "gold": 350, "info": "cunning and power-hungry ruler", 
                "loot": "Twinblade Arc Wand", "l_info": "A rare dual-purpose weapon combining two enchanted blades with arcane magic. Grants +15 Attack."}
        }
    },
    "Etheris": {
        ...
        "Enemies": {
            ...
            2: {"name": "Ether", "hp": 100, "atk": randint(55,75), "def": 30, "gold": 680, "info": "A cursed Bathaluman goddess bound in serpent form", 
                "loot": "Aegis Etherplate", "l_info": "A legendary armor forged from condensed ether crystals, known for its unmatched resilience. Grants +20 Defense."}
        }
    }
}